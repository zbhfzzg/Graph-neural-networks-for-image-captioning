...
if __name__ == '__main__':
    ...
    create_input_files(dataset='flickr30k',
                       karpathy_json_path = r'C:\Users\Bohan Zhang\Documents\GitHub\dataset\dataset_flickr30k.json', #指向包含训练集、验证集和测试集分割信息及字幕的JSON文件的路径。指向包含训练集、验证集和测试集分割信息及字幕的JSON文件的路径。

                       image_folder= r'C:\Users\Bohan Zhang\Documents\GitHub\dataset\flickr30k\Images',
